...
int main(int argc, char** argv) {
    ...
    map<string, double> p;
    int sa = sizeof(arr_s50c)/sizeof(arr_s50c[0]);
    ...
    //string st = "(r3*(((r1*(x4))+(r2*(x6*((r1*(x14)))))+(r2*(x8*(r2*(x32*((r1*(x14)))))))+(r2*(x5*((r2*(x13*((r1*(x14)))))+(r2*(x12*(r2*(x11*((r1*(x14)))))))))))*(ra*(((r1*(x1))+(r2*(x2*((r1*(x15))+(r2*(x16*((r1*(x9))))))))+(r2*(x3*(r2*(x32*((r1*(x15))+(r2*(x16*((r1*(x9)))))))))))))))";
